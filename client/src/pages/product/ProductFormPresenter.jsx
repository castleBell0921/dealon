...
export default function ProductFormPresenter({
                                                 formState,
                                                 handleInputChange,
                ...
                <form onSubmit={handleSubmit}>
                    <section className="photo-upload-section">
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '10px' }}>
                            {/* 1. 사진 업로드 버튼 */}
                            <label htmlFor="product-photo-upload" className="photo-placeholder text-14px" style={{cursor: 'pointer', flexShrink: 0}}>
                        ...
                        {/* 숨겨진 실제 input 태그 */}
                        <input type="file" id="product-photo-upload" multiple onChange={handleImageChange} accept="image/*" style={{display: 'none'}} />
                    </section>
                    ...
                    <section className="input-section">
                        ...
                        <div className="input-field price-input-wrapper">
                            ...
                            <input name="price" value={formState.price} onChange={handleInputChange} type="text" className="price-input-field text-20px" placeholder=" 판매가격" />
                        </div>
                        <label className="checkbox-label text-20px">
                            <input name="priceSuggestion" checked={formState.priceSuggestion} onChange={handleCheckboxChange} type="checkbox" className="checkbox" /> 가격 제안 받기
                        </label>
                    </section>
                    <section className="input-section">
